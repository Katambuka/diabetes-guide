...
const PrivacyPage = () => {
   return (
      <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', lineHeight: '1.6' }}>
         ...
         <ul>
            <li>
               <strong>Personal Information:</strong> Information you provide directly, such as your name, email address, and other contact details.
            </li>
            <li>
               <strong>Usage Data:</strong> Information about how you interact with our website, such as pages visited, time spent on pages, and other diagnostic data.
            </li>
         </ul>
         ...
         <p>
            <strong>Address:</strong> 123 Privacy Lane, Data City, DC 45678
         </p>
      </div>
   );
};
